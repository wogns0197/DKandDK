...
void AProjectDCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AProjectDCharacter::Look);
	}
}
...
void AProjectDCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AProjectDCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AProjectDCharacter::GetHasRifle()
{
	return bHasRifle;
}